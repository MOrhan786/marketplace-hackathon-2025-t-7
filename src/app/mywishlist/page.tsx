      ...
      {wishlistItems.length > 0 ? (
        wishlistItems.map((item , index:number) => (
          <div key={index} className="mb-4 border border-black p-2 rounded-md">
           ...
           <Image src={urlFor(item.image).url()} alt='loading' width={300} height={200} className="bg-[rgba(84,166,255,100%)] h-full rounded-xl bg-[url('/BG.png')] bg-cover bg-center relative p-6 w-[200px] lg:w-[230px]"></Image>
